<?php
	namespace DbmContentFiles\OddCore\Admin\Lists;
	
	// \DbmContentFiles\OddCore\Admin\Lists\EditList
	class EditList {
		...
		function __construct() {
			...
			$this->_columns["master-ingredient"] = new \DbmContentFiles\OddCore\Admin\Lists\EditListColumn();
		}
