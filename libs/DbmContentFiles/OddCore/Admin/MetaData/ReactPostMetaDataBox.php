<?php
	namespace DbmContentFiles\OddCore\Admin\MetaData;
	
	use \DbmContentFiles\OddCore\Admin\MetaData\PostMetaDataBox;
	
	// \DbmContentFiles\OddCore\Admin\MetaData\ReactPostMetaDataBox
	class ReactPostMetaDataBox extends PostMetaDataBox {
		...
		function __construct() {
			...
			//$portrait_image_meta_field = new \DbmContentFiles\OddCore\Admin\MetaData\MetaField();
		...
		public function output_box_start($post) {
			?>
				<div id="recipe-metadata" class="postbox">
					<h3><span><?php _e($this->_display_name, DBM_CONTENT_FILES_TEXTDOMAIN) ?></span></h3>
