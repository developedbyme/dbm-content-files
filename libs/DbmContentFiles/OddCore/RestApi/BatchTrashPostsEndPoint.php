<?php
	namespace DbmContentFiles\OddCore\RestApi;
	
	use \WP_Query;
	use DbmContentFiles\OddCore\RestApi\EndPoint as EndPoint;
	
	// \DbmContentFiles\OddCore\RestApi\BatchTrashPostsEndPoint
	class BatchTrashPostsEndPoint extends EndPoint {
		...
		public function perform_call($data) {
			...
			remove_action( 'transition_post_status',           array( '\DbmContentFiles\Helper\Headlines', 'transition_post_status' ), 10, 3 );
			remove_action( 'transition_post_status',           array( '\DbmContentFiles\Helper\PartnerPromotion', 'transition_post_status' ), 10, 3 );
